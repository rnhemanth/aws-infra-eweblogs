...
terragrunt plan -destroy -compact-warnings --terragrunt-forward-tf-stdout -out plan.out --terragrunt-config $TERRAGRUNT_CONFIG --terragrunt-non-interactive && terraform show -no-color plan.out > comment_plan.out
