...
Install-DbaInstance -Version 2022 -SqlInstance "$server.$ADDomain\$instance" -Feature Engine,FullText -AdminAccount $AdminAccounts -Configuration $config -Path $SqlInstallerPath -Confirm:$false -Restart  
