...
### EC2 ###
  ...
  servers = [
    {
      name                    = "SIS01"
      subnet_id               = "subnet-0d22dd1df992745d8"
      az                      = "eu-west-2c"
    ...
    # D: Drive - 2TB (was 10TB)
      d_volume_size           = 2048                       # 2TB
      d_volume_throughput     = 500
      d_volume_iops           = 6000
    
    # E: Drive - 3TB (was 16TB)  
      e_volume_size           = 3072                       # 3TB
      e_volume_throughput     = 500
      e_volume_iops           = 8000
    
    # F: Drive - 1TB (was 5TB)
      f_volume_size           = 1024                       # 1TB
      f_volume_throughput     = 250
      f_volume_iops           = 3000
    
    # G: Drive - 3TB (was 15TB)
      g_volume_size           = 3072                       # 3TB
      g_volume_throughput     = 500
      g_volume_iops           = 8000
    
    # H: Drive - 1TB (was 5TB)
      h_volume_size           = 1024                       # 1TB
      h_volume_throughput     = 250
      h_volume_iops           = 3000
    
    # I: Drive - 3TB (was 15TB)
      i_volume_size           = 3072                       # 3TB
      i_volume_throughput     = 500
      i_volume_iops           = 8000
    
    # J: Drive - 1TB (was 5TB)
      j_volume_size           = 1024                       # 1TB
      j_volume_throughput     = 250
      j_volume_iops           = 3000
    
    # K: Drive - 3TB (was 15TB)
      k_volume_size           = 3072                       # 3TB
      k_volume_throughput     = 500
      k_volume_iops           = 8000
    
    # L: Drive - 512GB (was 2TB)
      l_volume_size           = 512                        # 512GB
      l_volume_throughput     = 125
      l_volume_iops           = 3000
    
    # M: Drive - 768GB (was 3TB)
      m_volume_size           = 768                        # 768GB
      m_volume_throughput     = 125
      m_volume_iops           = 3000
    
    # N: Drive - 3TB (was 15TB)
      n_volume_size           = 3072                       # 3TB
      n_volume_throughput     = 500
      n_volume_iops           = 8000
    
    # O: Drive - 2.5TB (was 14TB)
      o_volume_size           = 2560                       # 2.5TB
      o_volume_throughput     = 500
      o_volume_iops           = 6000
