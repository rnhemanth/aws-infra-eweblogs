...
### VPC ###
  ipv4_primary_cidr_block       = "100.68.58.192/26" # UPDATE_ME
...
#  tgw_id_backbone               = "tgw-0f28603fcaf843cb9"
  ...
  intra_subnets = {
    ewl = {
      ewl-2a = {
        cidr_block           = "100.68.58.192/27" # UPDATE_ME
...
### EC2 ###
  ec2_name_prefix    = "dv"
###  domain_password_secret_arn = "arn:aws:secretsmanager:eu-west-2:069082606602:secret:dev-ew-sec-sm-sharedservices-ad-20230322221700472800000001-iZvKqT" ###
  servers = [
    {
      name                    = "SIS001"
      subnet_id               = "subnet-00b8cee4eccab5e01"
      az                      = "eu-west-2c"
