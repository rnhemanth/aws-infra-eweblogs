...
#        Read-Host "Continue or Not"
    ...
    Switch ($server) {
        ...
        {($_ -Match "ENEUW2DEV")} {$Environment = $Server.SubString(6,3); $SQLEnvironment = $Server.replace('RS-01','RS').Replace("-","_").Replace('DBS01','DB').replace('DBS02','DB');} #$CLSEnvironment = $Server.Substring(0,11).Replace('DBS01','DB').replace('DBS02','DB')}
        ...
        {($_ -Match "DVEUW2CM")} {$Environment = $Server.SubString(6,4); $SQLEnvironment = $Server.replace('RS-01','RS').Replace("-","_").Replace('DBS01','DB').replace('DBS02','DB');} #$CLSEnvironment = $Server.Substring(0,11).Replace('DBS01','DB').replace('DBS02','DB')}
        {($_ -Match "STEUW2CM")} {$Environment = $Server.SubString(6,4); $SQLEnvironment = $Server.replace('RS-01','RS').Replace("-","_").Replace('DBS01','DB').replace('DBS02','DB');} #$CLSEnvironment = $Server.Substring(0,11).Replace('DBS01','DB').replace('DBS02','DB')}
        {($_ -Match "ENEUW2CM")} {$Environment = $Server.SubString(6,4); $SQLEnvironment = $Server.replace('RS-01','RS').Replace("-","_").Replace('DBS01','DB').replace('DBS02','DB');} #$CLSEnvironment = $Server.Substring(0,11).Replace('DBS01','DB').replace('DBS02','DB')}
    ...
    #CCMH S-size environment
    IF ($Hostname -match "CM01|CM02|CM03|CM04|CM06|CM07|CM08|CM09|CM10|CM12|CM13|CM14|CM17|CM18|CM21|CM25|CM26|CM27|CM29|CM30|CM31|CM33|CM34|CM36|CM37|CM40|CM41|CM42") {
        IF ($Hostname -match "App") {$ServerType="App"}
        IF ($Hostname -match "App01|App07" -and $AppServicesSource.name -eq "Emis.Services.WindowsService" -and $AppServicesSource.name -eq "Emis.Scheduler.WindowsService") {$ServerType="EW-Priv-Sch"} #Was EW-Private
        IF ($Hostname -match "App03|App09" -and $AppServicesSource.name -eq "Emis.Services.WindowsService") {$ServerType="EW-Private"} #New
        IF ($Hostname -match "App02|App05|App08|App11" -and $AppServicesSource.name -eq "Emis.Services.WindowsService") {$ServerType="EW-Public"} #No change
        IF ($Hostname -match "App04|App10" -and $AppServicesSource.name -eq "Emis.ExternalMessaging.WindowsCoreService") {$ServerType="EMAS"} #No change
        IF ($Hostname -match "App06|App12" -and $AppServicesSource.name -eq "Emis.Services.WindowsService") {$ServerType="OWIN"} #New
    }

    #CCMH M-size environment
    IF ($Hostname -match "CM05|CM32") {  #Add CM environments
        IF ($Hostname -match "App") {$ServerType="App"}
        IF ($Hostname -match "App01|App09" -and $AppServicesSource.name -eq "Emis.Services.WindowsService" -and $AppServicesSource.name -eq "Emis.Scheduler.WindowsService") {$ServerType="EW-Priv-Sch"} #Was EW-Private
        IF ($Hostname -match "App03|App04|App11|App12" -and $AppServicesSource.name -eq "Emis.Services.WindowsService") {$ServerType="EW-Private"} #New
        IF ($Hostname -match "App02|App06|App10|App14" -and $AppServicesSource.name -eq "Emis.Services.WindowsService") {$ServerType="EW-Public"} #No change
        IF ($Hostname -match "App05|App13" -and $AppServicesSource.name -eq "Emis.ExternalMessaging.WindowsCoreService") {$ServerType="EMAS"} #No change
        IF ($Hostname -match "App07|App08|App15|App16" -and $AppServicesSource.name -eq "Emis.Services.WindowsService") {$ServerType="OWIN"} #New
    }

    #CCMH L-size environment
    IF ($Hostname -match "CM11") {  #Add CM environments
        IF ($Hostname -match "App") {$ServerType="App"}
        IF ($Hostname -match "App01|App11" -and $AppServicesSource.name -eq "Emis.Services.WindowsService" -and $AppServicesSource.name -eq "Emis.Scheduler.WindowsService") {$ServerType="EW-Priv-Sch"} #Was EW-Private
        IF ($Hostname -match "App04|App05|App06|App14|App15|App16" -and $AppServicesSource.name -eq "Emis.Services.WindowsService") {$ServerType="EW-Private"} #New
        IF ($Hostname -match "App02|App03|App08|App12|App13|App18" -and $AppServicesSource.name -eq "Emis.Services.WindowsService") {$ServerType="EW-Public"} #No change
        IF ($Hostname -match "App07|App17" -and $AppServicesSource.name -eq "Emis.ExternalMessaging.WindowsCoreService") {$ServerType="EMAS"} #No change
        IF ($Hostname -match "App09|App10|App19|App20" -and $AppServicesSource.name -eq "Emis.Services.WindowsService") {$ServerType="OWIN"} #New
    }
    
    #CCMH XL-size environment
    IF ($Hostname -match "CMxx") {  #Add CM environments
        IF ($Hostname -match "App") {$ServerType="App"}
        IF ($Hostname -match "App01|App14" -and $AppServicesSource.name -eq "Emis.Services.WindowsService" -and $AppServicesSource.name -eq "Emis.Scheduler.WindowsService") {$ServerType="EW-Priv-Sch"} #Was EW-Private
        IF ($Hostname -match "App05|App06|App07|App18|App19|App20" -and $AppServicesSource.name -eq "Emis.Services.WindowsService") {$ServerType="EW-Private"} #New
        IF ($Hostname -match "App02|App03|App04|App10|App15|App16|App17|App23" -and $AppServicesSource.name -eq "Emis.Services.WindowsService") {$ServerType="EW-Public"} #No change
        IF ($Hostname -match "App08|App09|App21|App22" -and $AppServicesSource.name -eq "Emis.ExternalMessaging.WindowsCoreService") {$ServerType="EMAS"} #No change
        IF ($Hostname -match "App11|App12|App13|App24|App25|App26" -and $AppServicesSource.name -eq "Emis.Services.WindowsService") {$ServerType="OWIN"} #New
    }
...
###################################################
    ...
    Switch ($Environment.Length) {
        {$_ -eq 7} {$Environment = $Environment.SubString(3,4)}
        {$_ -eq 9} {$Environment = $Environment.SubString(5,4)}
        {($_ -Match "DVEUW2CM")} {$Environment = $Server.SubString(6,4)} 
        {($_ -Match "STEUW2CM")} {$Environment = $Server.SubString(6,4)}
