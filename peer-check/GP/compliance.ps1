...
#        Read-Host "Continue or Not"
    ...
    IF ($Hostname -match "App04|App05|App10|App11|App13|App14|App15|App16|App17|App18" -and $AppServicesSource.name -eq "Emis.Services.WindowsService") {$ServerType="EW-Public"}
    IF ($Hostname -match "App06|App12" -and $AppServicesSource.name -eq "Emis.ExternalMessaging.WindowsCoreService") {$ServerType="EMAS"}
    #New layout for GP01 App servers
    # IF ($Hostname -match "App03|App04|App05|App09|App10|App11" -and $AppServicesSource.name -eq "Emis.Services.WindowsService" -and $AppServicesSource.name -eq "Emis.Scheduler.WindowsService") {$ServerType="EW-Private"}
    # IF ($Hostname -match "App01|App02|App07|App08" -and $AppServicesSource.name -eq "Emis.Services.WindowsService") {$ServerType="EW-Public"}
    # IF ($Hostname -match "App06|App12" -and $AppServicesSource.name -eq "Emis.ExternalMessaging.WindowsCoreService") {$ServerType="EMAS"}
