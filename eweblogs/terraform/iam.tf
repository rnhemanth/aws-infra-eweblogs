...
resource "aws_iam_role_policy" "SessionManagerInstanceRolePolicy" {
...
resource "aws_iam_role_policy" "SharedServicesKMSAccess" {
  name = "SharedServicesKMSAccess"
  role = aws_iam_role.ec2_role.name
  policy = jsonencode({
    Version = "2012-10-17"
    Statement = [
      {
        ...
        Resource = "arn:aws:kms:eu-west-2:069082606602:key/cdac5c8e-ecd5-4784-98f5-98ac7e9ae8c7"
        Condition = {
          StringEquals = {
