...
- Check domain credentials secret access
- Verify security group rules allow AD traffic
- Ensure Route53 resolver rules are associated

**Disk Not Mounting:**
- Verify volume tags are correct (DriveLetter, DriveName)
- Check user data script execution in EC2 console
- Review CloudWatch logs for initialization errors

**Permission Denied:**
- Verify IAM instance profile attached correctly
