...
# Create gMSA users
$gmsaNameArray = "SQLService-$($ServiceAccount)", "SQLAgent-$($ServiceAccount)", "SQLBrowser-$($ServiceAccount)", "SQLSSIS-$($ServiceAccount)", "SQLSSRS-$($ServiceAccount)"
