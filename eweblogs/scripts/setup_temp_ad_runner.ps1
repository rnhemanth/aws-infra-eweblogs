...
Add-Content "$($repo_dir)\.env" "no_proxy=localhost,ec2.eu-west-2.amazonaws.com,ec2messages.eu-west-2.amazonaws.com,kms.eu-west-2.amazonaws.com,lambda.eu-west-2.amazonaws.com,s3.eu-west-2.amazonaws.com,secretsmanager.eu-west-2.amazonaws.com,email-smtp.eu-west-2.amazonaws.com,ssm.eu-west-2.amazonaws.com"
