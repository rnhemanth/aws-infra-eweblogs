...
if ($EnvironmentType -contains "northernireland") {
  $EnvironmentType = "ni" } 
...
$groupNameArray = "$EnvironmentType-auth-db","$EnvironmentType-auth-app","service-accounts","$authaccessgroup"
...
$groupsqlNameArray = "$EnvironmentType-auth-db","$authaccessgroup"
