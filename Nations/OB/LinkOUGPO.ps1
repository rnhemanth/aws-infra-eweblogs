...
if ($EnvironmentType -contains "fam") {
  $dbGpoArray = "fm-db-settings","db-firewall-policy"
  $appGpoArray = "fm-app-settings","app-firewall-policy"
}
else {
  $dbGpoArray = "$EnvironmentType-db-settings","db-firewall-policy"
  $appGpoArray = "$EnvironmentType-app-settings","app-firewall-policy"
} 
...
try {
    # App OU GP links
    $appOu = "OU=App_Servers,OU="+$pdNumber+",OU=$EnvironmentType,"+$Domain
    ...
    # DB OU GP links
    $dbOu = "OU=DB_Servers,OU="+$pdNumber+",OU=$EnvironmentType,"+$Domain
